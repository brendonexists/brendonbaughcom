...
<div class="bb-mobile-header lg:hidden">
	<div class="bb-mobile-topbar bb-container">
		<details class="bb-mobile-panel" data-bb-mobile-menu>
			<summary class="bb-menu-btn" aria-controls="bb-mobile-menu-panel" aria-expanded="false">
				<span class="bb-menu-icon" aria-hidden="true"></span>
				<span class="bb-menu-label"><?php esc_html_e('Menu', 'brendon-core'); ?></span>
			</summary>
			<div class="bb-mobile-panel__backdrop" data-bb-mobile-backdrop></div>
			<div class="bb-mobile-panel__body" id="bb-mobile-menu-panel" role="dialog" aria-modal="true" aria-label="<?php echo esc_attr_x('Mobile navigation', 'aria label', 'brendon-core'); ?>">
				<div class="bb-mobile-panel__header">
					<span class="bb-mobile-panel__title"><?php esc_html_e( 'Navigation', 'brendon-core' ); ?></span>
					<button type="button" class="bb-mobile-panel__close" data-bb-mobile-close>
						<span class="sr-only"><?php esc_html_e( 'Close menu', 'brendon-core' ); ?></span>
						<span aria-hidden="true">Close</span>
					</button>
				</div>

				<div class="bb-mobile-panel__scroll">
					<nav class="bb-nav bb-nav--primary" aria-label="<?php echo esc_attr_x('Mobile sidebar menu', 'aria label', 'brendon-core'); ?>">
	...
	<header class="bb-mobile-header__title bb-container">
		<?php
		get_template_part(
